...
| `monolith.image.repository`    | Monolith image repository                       | `ghcr.io/mihailsergeenkov/architecture-pro-cinemaabyss/monolith:latest` |
...
| `proxyService.image.repository`| Proxy service image repository                  | `ghcr.io/mihailsergeenkov/architecture-pro-cinemaabyss/proxy-service:latest` |
...
| `moviesService.image.repository`| Movies service image repository                | `ghcr.io/mihailsergeenkov/architecture-pro-cinemaabyss/movies-service:latest` |
...
| `eventsService.image.repository`| Events service image repository                | `ghcr.io/mihailsergeenkov/architecture-pro-cinemaabyss/events-service:latest` |
